...
INSERT INTO Locations (lattitude, longitude, country_state, city, zip_code) VALUES
    ('44.288778', '-85.594462', 'New York', 'New York City', '10001');

insert into ContractTypes (work_type) values ('full-time');
insert into ContractTypes (work_type) values ('part-time');
insert into ContractTypes (work_type) values ('contract');
